...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/76b9380-rpi_imager_screenshot.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c8c3895-rpi_splashpage.png",
        "rpi_splashpage.png",
        683,
        452,
        "#dc95a9"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/47b5357-usecustom_screenshot.png",
        "usecustom_screenshot.png",
        678,
        446,
        "#ecdbe0"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/75b6672-img_ss.png",
        "img_ss.png",
        643,
        438,
        "#f5f5f5"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/04a3ed4-storage_ss.png",
        "storage_ss.png",
        679,
        450,
        "#f1e0e4"
...
[block:api-header]
{
  "title": "Connect your Raspberry Pi to WiFi"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/38e0f5f-pi_login_ss.png",
        "pi_login_ss.png",
        561,
        338,
        "#020202"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ab352f4-raspi-config_ss.png",
        "raspi-config_ss.png",
        559,
        304,
        "#9790a8"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bd15d9f-wireless_lan_ss.png",
        "wireless_lan_ss.png",
        559,
        311,
        "#948da9"
...
[block:callout]
{
  "type": "info",
  "title": "Helpful Hint:",
  "body": "Enter the command 'ping 8.8.8.8'  in the terminal to verify if your Raspberry Pi is successfully connected to the internet."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4bcbfdf-ifconfig_ss.png",
        "ifconfig_ss.png",
        732,
        155,
        "#151112"
...
{
  "type": "info",
  "title": "Jot the inet Address Down",
  "body": "You will need this address to ssh into the Raspberry Pi later"
}
[/block]

[block:api-header]
{
  "title": "WAYV Air Configuration"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aeb0c6f-IMG_1729.jpg",
        "IMG_1729.jpg",
        3024,
        4032,
        "#607789"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2d8ac53-wifi_ss.png",
        "wifi_ss.png",
        361,
        624,
        "#e1dfdc"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/29d9f2f-view_network_ss.png",
        "view_network_ss.png",
        452,
        679,
        "#ede9e8"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6b705e3-properties_ss.png",
        "properties_ss.png",
        951,
        490,
        "#f8f9f9"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dd2131a-ipv4_properties_ss.png",
        "ipv4_properties_ss.png",
        784,
        475,
        "#ededed"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b29d83f-visualizer_ss.png",
        "visualizer_ss.png",
        1017,
        793,
        "#fafafa"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a7a3109-wa_settings_ss.png",
        "wa_settings_ss.png",
        275,
        219,
        "#e9e9ea"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3d2d692-system_config_ss.png",
        "system_config_ss.png",
        912,
        778,
        "#eff0ef"
      ]
...
[block:callout]
{
  "type": "info",
  "title": "inet Address",
  "body": "This is the number you recorded previously"
}
[/block]
...
[block:code]
{
  "codes": [
    {
      "code": "sudo systemctl stop radar_app.service\n\nsudo pkill -f wayv -e",
      "language": "text"
    }
  ]
}
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/67d888d-1.png",
        "1.png",
        1920,
        1080,
        "#dfe5ed"
...
[block:callout]
{
  "type": "info",
  "title": "Helpful Hint",
  "body": "For more information about the PeopleCount application's arguments run **python3 radar_threshold_app.py -h**"
}
[/block]
...
{
  "type": "info",
  "body": "Din -> Dout = A person is entering the building\nDout -> Din = A person is leaving the building",
  "title": "What are Din and Dout?"
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "DeviceKey",
  "body": "Use the serial number of the WAYV Air as the devicekey. Be sure to record the devicekey for later"
}
[/block]
...
{
  "type": "warning",
  "body": "Replace x, z, in, out with the values determined above",
  "title": ""
}
[/block]
...
[block:api-header]
{
  "title": "PeopleCount Application Setup"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fe55d17-peoplecount_ss.png",
        "peoplecount_ss.png",
        1919,
        936,
        "#7480fd"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/38b1582-live_counter_ss.png",
        "live_counter_ss.png",
        201,
        508,
        "#0fc7ba"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6bea5e8-options_ss.png",
        "options_ss.png",
        1917,
        592,
        "#ddf2f5"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a6cef0e-device_id_ss.png",
        "device_id_ss.png",
        1307,
        833,
        "#eff2fc"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1c8911e-counter_ss.png",
        "counter_ss.png",
        588,
        642,
        "#f3f2f4"
