...
velocity from the sensor to the terrain (altitude) are derived by the difference in time  
from when the signal is sent from the sensor to when the signal is received by the  
sensor.  
